...
**J) **
The arrest probability coefficient in model 1 is -0.000542, meaning that if arrest probability increases by one percentage point, it is expected that the crimes committed per person to decrease by 0.000542. In model 2, the arrest probability coefficient is -0.000266, less negative than in model 1. The density coefficient is 0.00832 meaning that as you increase the number of people per square mile by 1000, we expect an increase in crimes committed per person of 0.00832. As stated, the coefficient on arrest probability is less negative in model 2 than in model 1, and we have introduced a new explanatory variable in population density. The first model overestimates the effect of arrest probability on crime rate due to omitted variable bias from not controlling for population density. The correlation between arrest probability and density is -0.3,
